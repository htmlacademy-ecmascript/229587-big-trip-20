...
import { POINT_OPTIONS, DATETIME_FORM_FORMAT, TRAVEL_POINTS, OFFERS_OPTION } from '../const.js';
...
const createDestinationListTemplate = () =>
  TRAVEL_POINTS.map((city) => `<option value="${city}"></option>`).join('');
...
export default class CreationView extends AbstractView {
