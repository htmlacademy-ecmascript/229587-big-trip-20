import { DateTimeFormat, POINT_OPTIONS, UserAction, BLANK_TRIP_POINT } from '../const.js';
...
export default class EditView extends AbstractStatefulView {
  ...
  constructor({
    ...
    super();
    this._setState(EditView.parseTripPointToState(tripPoint));
  ...
  reset(tripPoint) {
    this.updateElement(EditView.parseTripPointToState(tripPoint));
  }
  ...
  #formSubmitHandler = (evt) => {
    evt.preventDefault();
    this.#handleFormSubmit(EditView.parseStateToTripPoint(this._state));
  };

  #formDeleteClickHandler = (evt) => {
    evt.preventDefault();
    this.#handleDeleteClick(
      EditView.parseStateToTripPoint(this._state)
    );
  };
